  ...
  return (
    <div className="w-full h-[80px] flex justify-between text-sm border-b border-solid border-rose-100 py-4">
      ...
      <div className="flex items-center">
        <button
          onClick={onRemove}
          className="w-4 h-4 rounded-full border border-solid border-rose-400 hover:border-rose-900 flex items-center justify-center text-rose-400 hover:text-rose-900"
        >
          <RemoveIcon />
        </button>
      </div>
